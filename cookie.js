<script>
(function() {
    // Location detection from ipinfo.io
...
// Cookie Consent Configuration and Implementation
const config = {
...
// Initialize dataLayer and UET queue
window.dataLayer = window.dataLayer || [];
...
// Cookie databases (UET and GA4 as requested)
const cookieDatabase = {
    // UET Cookies
    '_uetms': { category: 'advertising', duration: '1 day', description: 'Microsoft UET tracking' },
    ...
    '_uetmsclkid': { category: 'advertising', duration: '30 days', description: 'Microsoft UET click ID' },
    ...
    '_ga_<container-id>': { category: 'analytics', duration: '730 days', description: 'Google Analytics' },
    ...
    '_gat_gtag_<property-id>': { category: 'analytics', duration: '1 minute', description: 'Google Analytics throttle' },
    '_gac_<property-id>': { category: 'advertising', duration: '90 days', description: 'Google Ads conversion tracking' },
...
// Translations (only en and fr as requested)
const translations = {
    en: {
...
// Keep all country mappings but only use en and fr languages
const countryLanguageMap = {
    ...
    'RO': 'ro', 'SK': 'sk', 'SI': 'sl', 'ES': 'es', 'SE': 'sv',
    
    // Other European countries
    'AL': 'en', 'BA': 'en', 'IS': 'en', 'LI': 'de', 'MK': 'en', 'NO': 'en', 
    'RS': 'en', 'CH': 'de', 'CH': 'fr', 'CH': 'it', 'UA': 'uk', 'GB': 'en',
    
    // Rest of the world
    'US': 'en', 'CA': 'en', 'CA': 'fr', 'AU': 'en', 'NZ': 'en', 'ZA': 'en', 
