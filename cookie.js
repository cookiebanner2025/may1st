(function() {
    ...
    const cookieDatabase = {
        ...
        '_ga': { category: 'analytics', duration: '2 years', description: 'Google Analytics - Used to distinguish users' },
        ...
        '_gat_gtag_UA_': { category: 'analytics', duration: '1 minute', description: 'Google Analytics - Throttles requests' },
        
        // Microsoft UET Cookies
        '_uetvid': { category: 'advertising', duration: '1 year', description: 'Microsoft Advertising - Unique visitor ID' },
        '_uetsid': { category: 'advertising', duration: '30 minutes', description: 'Microsoft Advertising - Session ID' },
        '_uetmsclkid': { category: 'advertising', duration: '90 days', description: 'Microsoft Advertising - Click ID' },
        'MUID': { category: 'advertising', duration: '1 year', description: 'Microsoft Advertising - Unique user ID' },
        'MUIDB': { category: 'advertising', duration: '1 year', description: 'Microsoft Advertising - Cached unique user ID' },
        
        // Essential Cookies
        'cookie_consent': { category: 'functional', duration: '1 year', description: 'Stores user cookie consent preferences' },
        'PHPSESSID': { category: 'functional', duration: 'Session', description: 'PHP session cookie' }
    };
